...
static const uint16_t sdio_cmd_clk_program_instructions[] = {
    ...
    0xa34d, //  1: mov    y, !status      side 0 [3] 
    0x1261, //  2: jmp    !y, 1           side 1 [2] 
    0x6360, //  3: out    null, 32        side 0 [3] 
    0x7228, //  4: out    x, 8            side 1 [2] 
    0xe301, //  5: set    pins, 1         side 0 [3] 
    0xf281, //  6: set    pindirs, 1      side 1 [2] 
    0x6301, //  7: out    pins, 1         side 0 [3] 
    0x1247, //  8: jmp    x--, 7          side 1 [2] 
    0xe380, //  9: set    pindirs, 0      side 0 [3] 
    0x7228, // 10: out    x, 8            side 1 [2] 
    0xa342, // 11: nop                    side 0 [3] 
    0x1231, // 12: jmp    !x, 17          side 1 [2] 
    0xa342, // 13: nop                    side 0 [3] 
    0x12cd, // 14: jmp    pin, 13         side 1 [2] 
    0x4301, // 15: in     pins, 1         side 0 [3] 
    0x124f, // 16: jmp    x--, 15         side 1 [2] 
    0x8320, // 17: push   block           side 0 [3] 
            //     .wrap
};
...
static const uint16_t sdio_data_rx_program_instructions[] = {
    ...
    0x2692, //  2: wait   1 gpio, 18             [6] 
    0x4504, //  3: in     pins, 4                [5] 
    0x0043, //  4: jmp    x--, 3                     
            //     .wrap
};
...
static const uint16_t sdio_data_tx_program_instructions[] = {
    ...
    0x2892, //  1: wait   1 gpio, 18             [8] 
    0x6304, //  2: out    pins, 4                [3] 
    0x0242, //  3: jmp    x--, 2                 [2] 
    0xe380, //  4: set    pindirs, 0             [3] 
            //     .wrap_target
    0x4201, //  5: in     pins, 1                [2] 
    0x0385, //  6: jmp    y--, 5                 [3] 
    0x22a0, //  7: wait   1 pin, 0               [2] 
